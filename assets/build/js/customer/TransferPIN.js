function create_transfer(){
    var amount_transfer = document.getElementById('amount_transfer').value;
    ...
    if(amount_transfer != ''){
        if(secure_pin != ''){
            if(recipient_username != ''){
                ...
                $.ajax({
                    ...
                    type: "post",
                    data: {'type':'pin', 'secure_pin':secure_pin, 'id':id, 'amount_transfer':amount_transfer, 'recipient_username':recipient_username},
        ...
        show_message('warning', 'Oops! something went wrong', 'amount is empty');
    }
}